...
export default function ContactsMap() {
    ...
    const [formStatus, setFormStatus] = useState(""); // Stato per feedback all'utente
    ...
    const handleSubmit = (e) => {
        ...
        .then(data => {
            setFormStatus("Messaggio inviato con successo!"); // Feedback positivo
        })
        .catch(error => {
            console.error('Errore:', error);
            setFormStatus("Errore durante l'invio del messaggio."); // Feedback di errore
        });
    };
            ...
            <div className="container pt-5 mb-5">
                <div className="row justify-content-between">
                    ...
                    <animated.div className="col-lg-7 mb-lg-4" ref={formRef} style={formFlip}>
                        ...
                        {/* Feedback dopo l'invio del form */}
